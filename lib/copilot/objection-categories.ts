...
export const COPILOT_OBJECTION_CATEGORIES: Record<string, ObjectionCategoryMetadata> = {
  'price-objection': {
    ...
    examplePhrases: [
      ...
      "I can't spend this much",
      "I cannot spend this much",
      "The fee is too high",
      "This costs too much",
      "This is financially difficult for me",
  ...
  'trust-and-credibility': {
    ...
    examplePhrases: [
      ...
      'Is this legitimate?',
      'I was cheated by another consultancy',
      'Can you prove this actually works?',
      'Do you have proof that your placements are real?',
  ...
  'already-applying-myself': {
    ...
    examplePhrases: [
      ...
      'I can manage the job search myself',
    ],
    hiddenConcernPatterns: [
  ...
  'already-working-with-consultancy': {
    ...
    examplePhrases: [
      ...
      "I already have a placement agency",
      "Another agency is marketing my profile",
      "I signed a contract with another career service",
    ],
    hiddenConcernPatterns: [
  ...
  'parents-spouse-approval': {
    ...
    examplePhrases: [
      ...
      'My husband needs to agree before I enroll',
      'My parents want to decide together',
      'I have to check with my family',
      'My spouse wants to review the plan',
      'My father handles these decisions',
    ],
    hiddenConcernPatterns: [
  ...
  'not-interested': {
    ...
    examplePhrases: [
      ...
      "I'm not interested in the premium package",
      "I'm not interested in your Elite plan",
      "I'm not interested in this placement service",
      "I'm not interested in this opportunity",
  ...
  'explicit-refusal': {
    ...
    examplePhrases: [
      ...
      "Stop texting me.",
      "No more calls.",
      "I've told you before, stop calling.",
    ],
    hiddenConcernPatterns: [
