CREATE TYPE "public"."copilot_user_role" AS ENUM('advisor', 'admin');--> statement-breakpoint
...
CREATE TABLE "auth_users" (
	...
	"image" text,
	"role" "copilot_user_role" DEFAULT 'advisor' NOT NULL,
	"level_c_enabled" boolean DEFAULT false NOT NULL,
